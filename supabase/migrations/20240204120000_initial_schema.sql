...
DROP POLICY IF EXISTS "Allow public read" ON public.financial_metrics;
CREATE POLICY "Allow public read" ON public.financial_metrics FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow public read" ON public.plans;
...
DROP POLICY IF EXISTS "Allow public read" ON public.marketing_stats;
CREATE POLICY "Allow public read" ON public.marketing_stats FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow public read" ON public.budget;
